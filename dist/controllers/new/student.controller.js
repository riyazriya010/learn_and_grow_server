    ...
    studentLogin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, responseUtil_1.SuccessResponse)(res, 200, 'Student Found', response, String(accessToken), String(refreshToken));
                return;
            }
            catch (error) {
    ...
    studentSignUp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, responseUtil_1.SuccessResponse)(res, 201, " Student Added Successfully", addUser, String(accessToken), String(refreshToken));
                return;
            }
            catch (error) {
                if (error instanceof Error) {
    ...
    studentGoogleSignUp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, responseUtil_1.SuccessResponse)(res, 201, 'Student Added Successfully', addStudent, String(accessToken), String(refreshToken));
                return;
            }
            catch (error) {
                if (error instanceof Error) {
    ...
    studentGoogleLogin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, responseUtil_1.SuccessResponse)(res, 200, "Student Found", findUser, String(accessToken), String(refreshToken));
                return;
            }
            catch (error) {
                if (error instanceof Error) {
