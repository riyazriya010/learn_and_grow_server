...
class UserRoutes {
    constructor() {
        ...
        this.userContorller = new students_controller_1.default();
    ...
    initializeRoutes() {
        ...
        this.router.post('/login', (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield this.userContorller.findUser(req, res);
        }));
        this.router.patch('/verify', (req, res) => __awaiter(this, void 0, void 0, function* () {
            console.log('verify route');
            yield this.userContorller.verifyUser(req, res);
        }));
    }
    getRouter() {
        return this.router;
